...
## Limpieza: se eliminaron bloques de entrenamiento/generadores/oversampling e impresión de dataset.
    ...
    for fname in os.listdir(model_dir):
        if fname.endswith(".keras") or fname.endswith(".h5"):
            ...
            try:
                ...
                models.append(m)
                logger.info(f"✅ Modelo cargado: {fpath} | input_shape={m.input_shape}")
            except Exception as e:
                logger.exception(f"❌ Error cargando {fpath}: {e}")
    return models
...
if __name__ == '__main__':
    ...
    # Iniciar Flask en hilo aparte y abrir túnel ngrok si se proporciona token
    public_url = None
